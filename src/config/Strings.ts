...
const StringsEn = {
  ...
  summaryPenalty: '+50% LOOT SALVAGED',
  greedLabel: 'GREED',
  hpLabel: 'HP',
  ...
  streakWarnLastChance: 'Daily Chest available — complete your quest today!',
  streakWarnSkipUsed: 'Skip-day used. Daily Chest ready tomorrow.',
  streakBrokenTitle: 'DAILY CHEST RESET',
  streakBrokenSub: 'Your chest refills today. No progress lost.',
  comebackTitle: 'GOOD TO SEE YOU',
  comebackSub: '2× SCRAP active for 24 hours — dive back in.',
